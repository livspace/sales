--http://reports.livspace.com/question/2462
...
where  pt.date_txn >= '2019-04-01'::date and project_city is not null and lower(project_city) not like '%other%' and lower(project_city) not like '%singapo%'  
