--http://reports.livspace.com/question/2295
...
sum(fact2.order_handling_fee) as order_handling_fee, sum(fact2.order_products_wt + fact2.order_handling_fee) as CGMV
from
