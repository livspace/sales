--http://reports.livspace.com/question/2342
...
where pvs.new_value=18 and (lower(project_city) like '%pune%' or lower(project_city) like '%pune%' or lower(project_city) like '%pune%') and lpb.status = 'ACTIVE'
