--http://reports.livspace.com/question/2011
...
prs.design_in_progress as "Converted Date"
...
where prs.project_created_at>= '2019-01-01'::date and prs.project_created_at<= '2019-03-31'::date and 
prs.project_stage_weight>=400
