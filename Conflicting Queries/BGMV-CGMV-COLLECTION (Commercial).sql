--http://reports.livspace.com/question/2396
...
where bgm.logged_month >= '2018-07-01'::date and project_city is not null and lower(project_city) not like '%other%' and lower(project_city) not like '%singapo%'  and prs.is_test_project=false and 
bgm.project_id not in (13212,	329777,	234935,	237754,	240322,	261576,	274745,	326849,	293430,	201113,	220181,	326308,	372090,	366171,	342931,	343004,	349821,	304431,	335554,	361870,
...
152616,	330586,	209475,	272877,	205554,	366074,	373736,	391971,	391975,	244482,	382074,	382047,	400526,	394450,	13212,	330301,	0,	95945,	44496,	4492,	189999 )
 ...
 and (prs.primary_cm  in ('Narzina Ahmed', 'Yashashree Deshpande','Tanvi Mehta')
 OR prs.primary_designer  in ('Kajal Sood',	'Shabina Shahin',	'Kriti Mehrotra',	'Hina Nigam',	'Pragati Bishnoi',	'Vashundhara Singh',	'Radhika Sharma'))
...
8075,	21136,	30788,	30790,	41192,	72435,	72482,	101834,	87617,	68196,	46582,	45359,	87555,	109016,	117033,	5396,	34153,	30938,	44431,	57144,	47691,	165084,	194085,	119117,	199565,326308,
152616,	330586,	209475,	272877,	205554,	366074,	373736,	391971,	391975,	244482,	382074,	382047,	400526,	394450,	13212,	330301,	0,	95945,	44496,	4492,	189999 )
and (lbp.primary_cm  in ('Narzina Ahmed', 'Yashashree Deshpande','Tanvi Mehta')
 OR lbp.primary_designer  in ('Kajal Sood',	'Shabina Shahin',	'Kriti Mehrotra',	'Hina Nigam',	'Pragati Bishnoi',	'Vashundhara Singh',	'Radhika Sharma'))
...
-- where  pt.date_txn >= '2018-07-01'::date and project_city is not null and lower(project_city) not like '%other%' and lower(project_city) not like '%singapo%'  and pt.status=4 and prs.is_test_project=false
-- and lower(pt.pay_method) in ('payu','paytm','other','cheque','wire_transfer','card','demand_draft','cash','discount_voucher','auto_bank_transfer','razor_pay','wallet_transfer','ingenico')
-- and prs.project_id not in (13212,	329777,	234935,	237754,	240322,	261576,	274745,	326849,	293430,	201113,	220181,	326308,	372090,	366171,	342931,	343004,	349821,	304431,	335554,	361870,
-- 363072,	365514,	366044,	366061,	372620,	373004,	373931,	179868,	175078,	283496,	295126,	358094,	168024,	261927,	207917,	181066,	25954,	30789,	262032,	272849,	286720,	18889,	18030,	175093,	391973,	
-- 8075,	21136,	30788,	30790,	41192,	72435,	72482,	101834,	87617,	68196,	46582,	45359,	87555,	109016,	117033,	5396,	34153,	30938,	44431,	57144,	47691,	165084,	194085,	119117,	199565,326308,
-- 152616,	330586,	209475,	272877,	205554,	366074,	373736,	391971,	391975,	244482,	382074,	382047,	400526,	394450,	13212,	330301,	0,	95945,	44496,	4492,	189999 )
