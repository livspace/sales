--http://reports.livspace.com/question/2400

select ou.stage,ou.city,ou.cm,ou.created,ou.sub,ou.primary_reason,count(*),min(ou.weight),ou.estimated_value,ou.budget_max,budget_min,ou.project_pincode,ou.primary_gm,ou.project_property_category,
