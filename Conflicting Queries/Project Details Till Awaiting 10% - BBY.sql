--http://reports.livspace.com/question/2285
...
where pvs.new_value=18 and (lower(project_city) like '%mumbai%' or lower(project_city) like '%thane%' or lower(project_city) like '%navi%') and lpb.status = 'ACTIVE' and prs.project_stage_weight<=280
