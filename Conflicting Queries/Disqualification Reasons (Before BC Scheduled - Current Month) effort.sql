--http://reports.livspace.com/question/2002
...
and prs.project_stage_weight<130 and prs.project_status='INACTIVE' and (pvs.created_at>= date_trunc('month', current_date))
