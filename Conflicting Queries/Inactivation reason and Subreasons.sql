--http://live-data.livspace.com/question/1364

select ou.stage,ou.city,ou.gm,ou.created,ou.sub,ou.primary_reason,count(*),min(ou.weight)  
...
where ou.created >= '2018-12-01'::date

group by ou.stage,ou.city,ou.gm,ou.created,ou.sub,ou.primary_reason
