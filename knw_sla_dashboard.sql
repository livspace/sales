...
(case when gmv.amount>0 and tp.amount>0 then greatest(tp.amount*10,gmv.amount) when gmv.amount>0 then gmv.amount else tp.amount*10 end) as "Tentative BGMV",
